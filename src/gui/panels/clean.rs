...
pub fn draw(ui: &mut egui::Ui, app: &mut MagicXApp) {
    ...
    widgets::page_title(ui, "\u{2726}", "Clean Memory", dark);
    ...
    widgets::card(ui, dark, |ui| {
        ...
        for (level, name, desc, color) in levels {
            ...
            ui.horizontal(|ui| {
                if widgets::colored_button(ui, name, color, 100.0, enabled) {
    ...
    widgets::card(ui, dark, |ui| match &msg.result {
        Ok(result) => {
            ...
            ui.horizontal(|ui| {
                ...
                widgets::stat_label(ui, "Total Freed", &freed_str, theme::GREEN, dark);
                widgets::stat_label(
                    ui,
                    "RAM Usage",
                    &format!(
            ...
            for r in &result.results {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.add_space(3.0);
                    ui.label(egui::RichText::new(&r.operation).size(11.0));
